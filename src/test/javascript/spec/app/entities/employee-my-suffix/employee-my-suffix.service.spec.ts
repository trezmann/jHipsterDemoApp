...
describe('Service Tests', () => {
    ...
    describe('EmployeeMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmployeeMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return EmployeeMySuffix', () => {

                let entity: EmployeeMySuffix;
                service.find(123).subscribe((_entity: EmployeeMySuffix) => {
                    entity = _entity;
                });
