...
describe('Service Tests', () => {
    ...
    describe('LocationMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LocationMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return LocationMySuffix', () => {

                let entity: LocationMySuffix;
                service.find(123).subscribe((_entity: LocationMySuffix) => {
                    entity = _entity;
                });
