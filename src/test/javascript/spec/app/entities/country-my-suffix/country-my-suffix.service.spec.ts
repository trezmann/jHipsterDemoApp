...
describe('Service Tests', () => {
    ...
    describe('CountryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CountryMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CountryMySuffix', () => {

                let entity: CountryMySuffix;
                service.find(123).subscribe((_entity: CountryMySuffix) => {
                    entity = _entity;
                });
