...
describe('Service Tests', () => {
    ...
    describe('DepartmentMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DepartmentMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return DepartmentMySuffix', () => {

                let entity: DepartmentMySuffix;
                service.find(123).subscribe((_entity: DepartmentMySuffix) => {
                    entity = _entity;
                });
