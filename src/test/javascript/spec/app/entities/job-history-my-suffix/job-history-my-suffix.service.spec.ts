...
describe('Service Tests', () => {
    ...
    describe('JobHistoryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(JobHistoryMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return JobHistoryMySuffix', () => {

                let entity: JobHistoryMySuffix;
                service.find(123).subscribe((_entity: JobHistoryMySuffix) => {
                    entity = _entity;
                });
